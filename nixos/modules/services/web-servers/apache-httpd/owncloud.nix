...
rec {
  ...
  extraConfig =
    ''
      Alias /owncloud/apps ${config.dataDir}/apps
      <Directory ${config.dataDir}/apps>
        ${allGranted}
      </Directory>

      Alias /owncloud "${documentRoot}/owncloud"
      <Directory "${documentRoot}/owncloud">
        ${builtins.readFile "${documentRoot}/owncloud/.htaccess"}
      </Directory>
  ...
  documentRoot = "${pkgs.owncloud}/www";
  ...
  startupScript = pkgs.writeScript "owncloud_startup.sh" ''
    ...
    if [ ! -d ${config.dataDir}/config ]; then
      ...
      cp -r ${documentRoot}/owncloud/apps/* ${config.dataDir}/apps/
    ...
    ${php}/bin/php ${documentRoot}/owncloud/occ upgrade || true
